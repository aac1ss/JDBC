package JDBC.Normal_Statement.Updating_Data;
import java.sql.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        String query= "UPDATE employees set name='Breach', job_title='Sr Q.A', salary=79980 where id=6;";
        ...
        try {
            ...
            System.out.println("---x---Updating Query---x---");
            if(rowsAffected>0){
